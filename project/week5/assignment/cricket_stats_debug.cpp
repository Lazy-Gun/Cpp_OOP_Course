        ...
        while(std::getline(csvFile, line)){
           ...
           // checks number of tokens in read in row trows error is not equal to 11
            ...
            try{
                ...
                /*
                // prints converted tokens
                std::cout << batting_pos <<" : " ;
                std::cout << runs <<" : " ;
                std::cout << balls <<" : " ;
                std::cout << fours <<" : " ;
                std::cout << sixes <<" : " ;
                std::cout << strike_rate << std::endl;*/
            }catch(std::exception& e){

                 /*
                 // prints out tokens 
                 std::cout << "Bad int batting pos: " << tokens[2] << std::endl;
                 std::cout << "Bad int runs: " << tokens[4] << std::endl;
                 std::cout << "Bad int balls: " << tokens[5] << std::endl;
                 std::cout << "Bad int fours: " << tokens[6] << std::endl;
                 std::cout << "Bad int sixes: " << tokens[7] << std::endl;
                 std::cout << "Bad float strike rate: " << tokens[8] << std::endl;*/
                 bad_lines +=1;
